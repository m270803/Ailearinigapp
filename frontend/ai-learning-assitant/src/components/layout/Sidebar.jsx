...
const Sidebar = ({ isSidebarOpen, toggleSidebar }) => {
  ...
  return (
    <>
      ...
      <aside
      className={`fixed top-0 left-0 h-full w-64 bg-white/90 backdrop-blur-lg border-r border-slate-200/60 z-50 flex flex-col md:relative md:w-64 md:shrink-0 md:translate-x-0 transition-transform duration-200 ease-in-out ${
  isSidebarOpen ? "translate-x-0" : "-translate-x-full"
      ...
      >
        ...
        {/* logout */}
        <div className="px-3 py-4 border-t border-slate-200/60 mt-auto">
          <button
