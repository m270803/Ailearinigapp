...
const RegisterPage = () => {
  ...
  return (
      ...
      <div className="relative w-full max-w-md px-6">
        <div className="bg-white border border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50 p-10">
          {/* Header */}
         ...
         <div className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              ...
              className='w-full h-12 pl-12 pr-4 border-2 border-slate-200 rounded-xl bg-slate-50/50 text-slate-900 placeholder-slate text-sm font-medium transition-all duration-200 focus:outline-none focus:border-emerald-500 focus:bg-white focus:shadow-lg focus:shadow-emerald-500/20'
        ...
        {/* submit button */}
         <button
          ...
          >
            ...
            <div className="absolute inset-0 bg-linear-to-r from-white/0 via-white/20 to-white/20 -translate-x-full transition-transform duration-700">
          ...
          <div className="mt-8 pt-6 border-t border-slate-200/60">
                   <p className="text-center text-sm text-slate-600 ">
                     ...
                     <Link to="/login" className="font-semibold text-emerald-500 hover:text-emerald-600 ml-1">
                       Log in
                     </Link>
                   </p>
          </div>
